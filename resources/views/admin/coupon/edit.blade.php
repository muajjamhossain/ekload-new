        ...
        <div class="card">
            ...
            <div class="card-body card_form">
              ...
              <div class="form-group row custom_form_group{{ $errors->has('coupon_start_date') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-7">
                    <input type="date" class="form-control" name="coupon_start_date" value="{{ $data->coupon_start_date }}" required data-parsley-trigger="keyup" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}">
