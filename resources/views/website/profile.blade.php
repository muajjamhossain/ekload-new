              ...
              {{-- <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">https://ekload.com</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info" href="{{ route('edit.user-profile') }}">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
                          ...
                          <div class="card-body">
                            <div class="table-responsive">
                                <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                    ...
                                    <tbody>
                                        @forelse ($allref as $key => $ref)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td>{{ $ref->name }}</td>
                                                <td>{{ $ref->phone }}</td>
                                                <td>{{ $ref->active_customer == 1? "Active": "inActive" }}</td>
                                            </tr>
                                        @empty
                                        <tr>
